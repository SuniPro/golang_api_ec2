...
CREATE TABLE `compensations` (
  ...
  `compensation` varchar(70) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_compensations_deleted_at` (`deleted_at`)
...
INSERT INTO `compensations` VALUES (1,'2022-11-04 18:35:31','2022-11-04 18:35:31',NULL,'qhfk','Adventure_pack1');
